					...
					case "Query":
						if (args[1] is string settingToQuery)
						{
							return settingToQuery switch
							{
								...
								"Calamitweaks_ForceWormContactDamage" or "ForceWormContactDamage" => ModContent.GetInstance<TerratweaksConfig>().calamitweaks.ForceWormContactDamage,
								...
								"Calamitweaks_NoPlantParticles" or "NoPlantParticles" => ModContent.GetInstance<TerratweaksConfig>().calamitweaks.NoPlantParticles,
