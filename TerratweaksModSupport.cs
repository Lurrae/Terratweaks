...
namespace Terratweaks
{
	...
	public class CalamityModSupport : ModSystem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<PerfectDark>()] = new List<int> { ModContent.ItemType<PerfectDark>(), ModContent.ItemType<Shadethrower>(), ModContent.ItemType<ShaderainStaff>(), ModContent.ItemType<DankStaff>(), ModContent.ItemType<RotBall>() };
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<VeinBurster>()] = new List<int> { ModContent.ItemType<VeinBurster>(), ModContent.ItemType<SausageMaker>(), ModContent.ItemType<Aorta>(), ModContent.ItemType<Eviscerator>(), ModContent.ItemType<BloodBath>(), ModContent.ItemType<FleshOfInfidelity>(), ModContent.ItemType<ToothBall>() };
			...
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<Greentide>()] = new List<int> { ModContent.ItemType<Greentide>(), ModContent.ItemType<Leviatitan>(), ModContent.ItemType<Atlantis>(), ModContent.ItemType<AnahitasArpeggio>(), ModContent.ItemType<Whitewater>(), ModContent.ItemType<PearlofEnthrallment>() };
			...
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<Virulence>()] = new List<int> { ModContent.ItemType<Virulence>(), ModContent.ItemType<Pandemic>(), ModContent.ItemType<Malevolence>(), ModContent.ItemType<PestilentDefiler>(), ModContent.ItemType<TheHive>(), ModContent.ItemType<BlightSpewer>(), ModContent.ItemType<PlagueStaff>(), ModContent.ItemType<FuelCellBundle>(), ModContent.ItemType<InfectedRemote>(), ModContent.ItemType<TheSyringe>() };
			...
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<TheStorm>()] = new List<int> { ModContent.ItemType<TheStorm>(), ModContent.ItemType<SkytideDragoon>() };
			...
			TerratweaksContentSets.ShimmerableBossDrops[ModContent.ItemType<MawOfInfinity>()] = new List<int> { ModContent.ItemType<MawOfInfinity>(), ModContent.ItemType<TheObliterator>(), ModContent.ItemType<ThreadOfEradication>(), ModContent.ItemType<HyperdeathRiftScepter>(), ModContent.ItemType<VoidEaterMarionette>(), ModContent.ItemType<DimensionTearingDisk>() };
